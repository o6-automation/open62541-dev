...
/* Add an application restriction to a role.
 *
 * @param server The server instance
 * @param roleId NodeId of the role
 * @param uri Application URI to add
 * @return UA_STATUSCODE_GOOD on success */
UA_StatusCode UA_EXPORT UA_THREADSAFE
UA_Server_addRoleApplication(UA_Server *server, UA_NodeId roleId,
                             UA_String uri);

/* Remove an application restriction from a role.
 *
 * @param server The server instance
 * @param roleId NodeId of the role
 * @param uri Application URI to remove
 * @return UA_STATUSCODE_GOOD on success */
UA_StatusCode UA_EXPORT UA_THREADSAFE
UA_Server_removeRoleApplication(UA_Server *server, UA_NodeId roleId,
                                UA_String uri);

/* Add an endpoint restriction to a role.
 *
 * @param server The server instance
 * @param roleId NodeId of the role
 ...
 * @return UA_STATUSCODE_GOOD on success */
UA_StatusCode UA_EXPORT UA_THREADSAFE
UA_Server_addRoleEndpoint(UA_Server *server, UA_NodeId roleId,
                          UA_EndpointType endpoint);

/* Remove an endpoint restriction from a role.
 *
 * @param server The server instance
 * @param roleId NodeId of the role
 ...
 * @return UA_STATUSCODE_GOOD on success */
UA_StatusCode UA_EXPORT UA_THREADSAFE
UA_Server_removeRoleEndpoint(UA_Server *server, UA_NodeId roleId,
                             UA_EndpointType endpoint);
